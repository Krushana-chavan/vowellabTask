...
import { setCartUpdate, setUser, setlastpath } from '../../redux/users/users';
		...
		if (validateEmail(formData.email) && validatePassword(formData.password)) {
			try {
				...
				if (resp.status == 200) {
					...
					// console.log('Response:', resp?.data?.data?.user)
			...
			<Modal.Body>
				{inputFormdisplay ?
					<div className="text-center m-auto md-p-4 border-0 col-md-12 col-lg-5 col-sm-12 ">
						...
						<a style={{ textDecoration: 'none' }} href={""} rel="noreferrer">
