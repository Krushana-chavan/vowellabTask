          ...
          <div className="text-center m-auto md-p-4 border-0 col-md-12 col-lg-3 col-sm-12">
            ...
            <div className={`mb-3 ${emailError ? 'was-validated' : ''}`}>
              ...
              <div className="form-group">
                <input
                  type="email"
                  className={`pb-2 form-control text-center border border-bottom border-top-0 border-end-0 border-start-0  input-outline-none rounded-0 ${emailError ? 'is-invalid border-danger' : ''
                    }`}
                  id="email"
                  name="email"
            ...
            <Button className="btn-lg bg-primary  border-0 rounded-0 w-100 pb-2 mb-5" onClick={handleSignUp} >
              Reset Password
            </Button>
          </div> : <div>
            <div style={{width:'100%', display:'flex', justifyContent:'center',padding:'30px 0'}}><MdMarkEmailRead style={{fontSize:'30px'}} /></div>
