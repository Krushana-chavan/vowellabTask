				...
				{inputFormdisplay ?
					...
					<div className='text-center m-auto md-p-4 border-0 col-md-12 col-lg-5 col-sm-12 '>
						...
						<div className="mb-3 ">
							...
							<input
								type="email"
								className={`form-control shadow-none  text-center border-0 btn-outline-primary rounded-0  border-bottom ${emailError ? "border-danger" : ""}`}
								id="email"
								name="email"
						...
						<div className="mb-3">
							...
							<input
								type={"password"}
								className={`form-control shadow-none text-center border-0 btn-outline-primary rounded-0  border-bottom ${passwordError ? "border-danger" : ""}`}
								id="password"
								name="password"
						...
						<Button disabled={buttonDisable}
							className={`btn-lg ${buttonDisable ? `bg-secondary opacity-50` : `bg-primary`} border-0 rounded-0 w-100`}
